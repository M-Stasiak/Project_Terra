...
Mushroom::Mushroom()
{
	...
	entityTexture.loadFromFile("Textures/Entities/Mushroom.png");
	setEntity(entityTexture, { {4, 0, 300, 150, 150}, {8, 0, 450, 150, 150}, { 25, 50, -50, -100 } });
...
void Mushroom::UpdateAI(float elapsed, Entity& player, map<int, map<int, B>>& world)
{
